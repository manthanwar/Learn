...
variable isn't set, its default or the empty string is inserted. When a variable
is unknown (that is, its name isn't defined) the name of the variable is
inserted and it is transformed into a placeholder.
...
- `CURRENT_TIMEZONE_OFFSET` The current UTC time zone offset as +HH:MM or -HH:MM
  (example -07:00).
